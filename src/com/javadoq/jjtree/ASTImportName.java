...
/**
 * <p>JJTree node for import name.</p>
 * 
 ...
 */
public class ASTImportName extends ASTName
{
	/**
	 * <p>Constructs a {@link ASTImportName} with a JJTreeParser.</p>
	 * @param p The JJTreeParser
	 * @param id The id.
	 * @since 1.0
	 */
	public ASTImportName(JJTreeParser p, int id) {
		super(p, id);
	}
}