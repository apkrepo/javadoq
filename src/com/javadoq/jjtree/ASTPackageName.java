...
/**
 * <p>JJTree node for package name.</p>
 * 
 ...
 */
public class ASTPackageName extends ASTName
{
	/**
	 * <p>Constructs a {@link ASTPackageName} with a JJTreeParser.</p>
	 * @param p The JJTreeParser
	 * @param id The id.
	 * @since 1.0
	 */
	public ASTPackageName(JJTreeParser p, int id) {
		super(p, id);
	}
}
