...
/**
 * <p>JJTree node for new Java names.</p>
 * 
 ...
 */
public class ASTNewName extends ASTName
{
	/**
	 * <p>Constructs a {@link ASTNewName} with a JJTreeParser.</p>
	 * @param p The JJTreeParser
	 * @param id The id.
	 * @since 1.0
	 */
	public ASTNewName(JJTreeParser p, int id) {
		super(p, id);
	}
}
