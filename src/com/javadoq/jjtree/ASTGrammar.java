...
{
	/**
	 * <p>Constructs a {@link ASTGrammar} without a JJTreeParser.</p>
	 * @param i The id.
	 * @since 1.0
	 */
	...
	/**
	 * <p>Constructs a {@link ASTGrammar} with a JJTreeParser.</p>
	 * @param p The JJTreeParser
	 * @param i The id.
	 * @since 1.0
	 */
	public ASTGrammar(JJTreeParser p, int i) {
		super(p, i);
	}
}
